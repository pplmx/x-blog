...
- 🧪 **Well Tested** - 2500+ tests (1243 backend + 1315 Nuxt), 93.5% backend coverage
...
- 📧 **Email notifications + weekly digest** - opted-in readers get per-event emails (new posts / replies / thread comments) and, optionally, one email per week summarizing everything newly published — both straight from the /notifications page (DEC-197, DEC-201)
...
- Nuxt (frontend): 1315 tests (Vitest)
