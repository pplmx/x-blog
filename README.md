...
- ✍️ **Author follow** - at a multi-editor blog a reader who loved one writer's posts subscribes to just that person: a follow button sits on the author byline of every post, the followed writers live in `/account` with per-writer notify toggle + unfollow, and every new post from that author lands in the follower's inbox as a durable row plus a Web Push — the person-shaped cousin of the topic-shaped category/series/tag follows (round 353)
