...
- ✍️ **关注作者** - 在多人协作的博客上，读者因喜欢某位作者的文章而想单独关注这个人：每篇文章的署名旁都有关注按钮，`/account` 里的「关注的作者」列表为每位作者提供独立通知开关与取消关注，该作者每发布一篇新文章都会以站内通知记录 + Web Push 推送给关注者——按主题的分类/系列/标签关注无法表达这种「人」形诉求（round 353）
